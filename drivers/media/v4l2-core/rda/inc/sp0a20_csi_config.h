...
static const struct sensor_reg init_sp0a20[] =
{
  ...
  {0xde,0x0f,BIT,0},//;
  {0xd7,0x08,BIT,0},//; ;sharp_flat_thr �����ж�
  {0xd8,0x08,BIT,0},//;
  {0xd9,0x10,BIT,0},//;
  {0xda,0x14,BIT,0},//;
  {0xe8,0x20,BIT,0},//;sharp_fac_pos ����ǿ��
  {0xe9,0x20,BIT,0},//;
  {0xea,0x20,BIT,0},//;
  {0xeb,0x20,BIT,0},//;
  ...
  {0xfd,0x02,BIT,0},//;
  {0xdc,0x05,BIT,0},//;��ɫ���� skin_sharp_sel
  {0x05,0x20,BIT,0},//;�ų���ɫ��`�񻯶Էֱ��ʿ�����ĸ���
  {0xfd,0x02,BIT,0},//
  ...
  {0xfd,0x01,BIT,0},//;�ط����Եƽ����ֵ��ԽСԽ��
  {0x6d,0x08,BIT,0},//;dns_flat_dif ǿƽ����ƽ̹������ƽ����ֵ  0x81��
  {0x6e,0x08,BIT,0},//;
  {0x6f,0x10,BIT,0},//;
  {0x70,0x18,BIT,0},//;
  {0x86,0x18,BIT,0},//;dark
  {0x71,0x0a,BIT,0},//;dns_edge_dif ����������ƽ̹������ƽ����ֵ	 0x81��
  {0x72,0x0a,BIT,0},//;
  {0x73,0x14,BIT,0},//;
  {0x74,0x14,BIT,0},//;
  ...
  {0x7b,0x22,BIT,0},//;
  {0x7c,0x0 ,BIT,0},//
  {0x81,0x0d,BIT,0},//;2x;dns_flat_thr ���������ж�������ֵ
  {0x82,0x18,BIT,0},//;4x
  {0x83,0x20,BIT,0},//;8x
  {0x84,0x24,BIT,0},//;16x
  {0xfd,0x02,BIT,0},//;dem
  ...
  {0xfd,0x01,BIT,0},//;��ɫ��������в�ɫ�������ʹ�ֵ;uv_th
  {0xc2,0xaa,BIT,0},//;
  {0xc3,0x88,BIT,0},//;
  {0xc4,0x77,BIT,0},//;
  {0xc5,0x66,BIT,0},//;
