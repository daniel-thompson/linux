...
static const RDA_FM_REG_T RDA5820NS_RX_initialization_reg[]={
	...
	{0x05, 0x86AF},  //LNAP  0x884F --LNAN; 0x888F -- �������; 0x0x88AF -- ��������
	{0x06, 0x6000},
	{0x13, 0x80E1},
	{0x14, 0x2A11},
	{0x1C, 0x22DE},
...
static const RDA_FM_REG_T RDA5801_TX_initialization_reg[]={
	...
	{0xFF, 100},    // wait
	{0x02, 0xC001},  //Power Up
	{0x05, 0x88CF},  //LNAP  0x884F --LNAN; 0x888F -- �������; 0x0x88AF -- ��������
	{0x06, 0x6000},
	{0x13, 0x80E1},
	{0x14, 0x2A11},
	{0x1C, 0x22DE},
...
static const RDA_FM_REG_T RDA5801_RX_initialization_reg[]={
	...
	{0xFF, 100},    // wait
	{0x02, 0xC001},  //Power Up
	{0x05, 0x86CF},  //LNAP  0x884F --LNAN; 0x888F -- �������; 0x0x88AF -- ��������
	{0x06, 0x6000},
	{0x13, 0x80E1},
	{0x14, 0x2A11},
	{0x1C, 0x22DE},
...
static int  fm_scan(struct fm *fm, struct fm_scan_parm *parm)
{
	int ret = 0;
	uint16_t tRegValue = 0;
	uint16_t scandir = FM_SEEK_UP; //scandir ��������
	uint8_t space = 1;
	struct i2c_client *client = fm->i2c_client;
